The irp_classes.php implements the core algorithms required for working with IR remote control, i.e. encode and decode RAW IR commands.
...
In this dir, with irp_classes.php, you can found also 2 example applications:
...
-------------
Copy all in the web area of your server: e.g. ' ...\apache\htdocs\www\phpIRPlib'.
------------- optional
